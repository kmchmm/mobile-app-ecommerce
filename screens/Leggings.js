...
export default function Leggings () {
    ...
    return (
        <SafeAreaView>
            <ScrollView>
                <Text style = {{textAlign: 'center', fontSize: 28, fontFamily: 'Poppins-Bold', marginTop: 15}}>LEGGINGS</Text>
                ...
                <View style= {[styles.brasGridImagesContainer, {marginTop: 20}]}>
                    <View style={[styles.brasGridImagesWrap]}>
                        <Image source={require('../assets/images/leggings/leggings010.png')}
                    ...
                    <View style={[styles.brasGridImagesWrap]}>
                        <Image source={require('../assets/images/leggings/leggings011.png')}
                            style ={[styles.brasGridImages]}
                        />
                        <Text style={{backgroundColor: '#f2f2f2', marginBottom: 9, marginTop: 5}}>BACK IN STOCK</Text>
                        <Text style={{fontFamily: 'Poppins-Bold'}}>Lorem Ipsum is simply dummy text.</Text>
                ...
                <View style= {[styles.brasGridImagesContainer, {marginTop: 20}]}>
                    <View style={[styles.brasGridImagesWrap]}>
                        <Image source={require('../assets/images/leggings/leggings012.png')}
                            style ={[styles.brasGridImages]}
                        />
                        <Text style={{backgroundColor: '#f2f2f2', marginBottom: 9, marginTop: 5}}>BACK IN STOCK</Text>
                        <Text style={{fontFamily: 'Poppins-Bold'}}>Lorem Ipsum is simply dummy text.</Text>
                    ...
                    <View style={[styles.brasGridImagesWrap]}>
                        <Image source={require('../assets/images/leggings/leggings013.png')}
                            style ={[styles.brasGridImages]}
                        />
                        <Text style={{backgroundColor: '#f2f2f2', marginBottom: 9, marginTop: 5}}>BACK IN STOCK</Text>
                        <Text style={{fontFamily: 'Poppins-Bold'}}>Lorem Ipsum is simply dummy text.</Text>
