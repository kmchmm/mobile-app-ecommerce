...
export default function Bras () {
    ...
    return (
        <SafeAreaView>
            <ScrollView>
                <Text style = {{textAlign: 'center', fontSize: 28, fontFamily: 'Poppins-Bold', marginTop: 15}}>BRAS</Text>
                ...
                <View style= {[styles.brasGridImagesContainer, {marginTop: 20}]}>
                    <View style={[styles.brasGridImagesWrap]}>
                        <Image source={require('../assets/images/bra/lua-yoga-bra-1.png')}
                    ...
                    <View style={[styles.brasGridImagesWrap]}>
                        <Image source={require('../assets/images/bra/lua-yoga-bra-2.png')}
                            style ={[styles.brasGridImages]}
                        />
                        <Text style={{backgroundColor: '#f2f2f2', marginBottom: 9, marginTop: 5}}>NEW</Text>
                        <Text style={{fontFamily: 'Poppins-Bold'}}>Lorem Ipsum.</Text>
                        <Text>(Color)</Text>
                        <Text style={{fontSize: 14}}>$0.00</Text>
                    </View>
                </View>
                ...
                <View style= {[styles.brasGridImagesContainer, {marginTop: 20}]}>
                    <View style={[styles.brasGridImagesWrap]}>
                        <Image source={require('../assets/images/bra/lua-yoga-bra-10.png')}
                            style ={[styles.brasGridImages]}
                        />
                    ...
                    <View style={[styles.brasGridImagesWrap]}>
                        <Image source={require('../assets/images/bra/lua-yoga-bra-11.png')}
                            style ={[styles.brasGridImages]}
                        />
                        <Text style={{backgroundColor: '#f2f2f2', marginBottom: 9, marginTop: 5}}>BEST SELLER</Text>
                        <Text style={{fontFamily: 'Poppins-Bold'}}>Lorem Ipsum is simply dummy text.</Text>
                        <Text>(Color)</Text>
                        <Text style={{fontSize: 14}}>$0.00</Text>
                    </View>
